...
# This finds the folder where app.py is currently located
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# Joins the folder path with your file names automatically
CSV_PATH = os.path.join(BASE_DIR, 'classified_reviews_all_pages.csv')
LAMARTINE_SCRAPER_PATH = os.path.join(BASE_DIR, 'scraper_lamartine.py')
DYNAMIC_SCRAPER_PATH = os.path.join(BASE_DIR, 'main.py')
# Updated for save_hotels path
GROK_SCRIPT_PATH = os.path.join(BASE_DIR, 'openaient.py') 
# --------------------------------------------
...
def save_hotels():
    ...
    # Using the dynamic path here
    os.system(f'python3 "{GROK_SCRIPT_PATH}" "{fixed_names}"')
